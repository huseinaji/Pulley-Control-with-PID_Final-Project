...
{
    while(1){
        printf("status: %d,%d,%d LIDAR:%d PresSpeed:%03d PresLoad:%0.2f% PresVol:%0.2f distance = %g cm\n", GPIORead(7),status_pulley, status_servobawah,Lidar_data, dxl_present_speed, load, voltage, pTali1);
        usleep(500*1000);
        system("clear");
    }
}
