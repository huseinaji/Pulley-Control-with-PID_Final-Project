...
void bacaencod()
{
	...
	while(1){
        ...
        pTali1 = fabs(3.14 * (sudut1/360));
        
        encoderLast2 = n2;
        sudut2 = (float)encoderPos2/100*360;
        pTali2 = fabs(3.14 * (sudut2/360));
...
void bacaEncod1()
{
	...
	while(1){
		...
		encoderLast1 = n1;
        sudut1 = (float)encoderPos1/100*360;
        pTali1 = 3.14 * (sudut1/360);
        //if(pTali1 <= 0){pTali1 = fabs(pTali1);}
	}
}
...
void bacaEncod2()
{
	...
	while(1){
		...
		encoderLast2 = n2;
        sudut2 = (float)encoderPos2/100*360;
        pTali2 = 3.14 * (sudut2/360);
        //if(pTali2 <= 0){pTali2 = fabs(pTali2);}
	}
}
...
void baca()
{
    ...
    while(1){
        ...
        //printf("status: %d,%d,%d LIDAR:%d PresSpeed:%03d PresLoad:%0.2f% PresVol:%0.2f distance = %g cm time_landg: %0.2d\n", GPIORead(7),status_pulley, status_servobawah,Lidar_data, dxl_present_speed, load, voltage, pTali1, timex);
        printf("time: %d\n", sampling);
        usleep(500*1000);
        sampling = micros();
        //system("clear");
