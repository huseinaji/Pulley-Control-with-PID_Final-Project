...
void baca()
{
    ...
    while(1){
        ...
        printf("status: %d,%d PresSpeed:%03d PresLoad:%0.2f% PresVol:%0.2f d1 = %0.2f d2 = %0.2f cm kec: %g\n", 
        GPIORead(7),status_pulley, dxl_present_speed, load, voltage, pTali1, pTali2, kecepatan);
